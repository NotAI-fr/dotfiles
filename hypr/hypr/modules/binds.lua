...
local screenshot        = "hyprshot -m region -o /home/nobloat/Pictures/Screenshots"
local lock              = "hyprlock"
...
local wallpaperswitcher = "/home/nobloat/.config/rofi/scripts/Wallpaper.sh"
local anime             = "curd -rofi"
...
hl.bind(mainMod .. " + A", hl.dsp.exec_cmd(anime))
